...
/*   Updated: 2023/03/27 22:36:27 by absalhi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_player(t_game *g)
{
	...
	pos.i = g->player.pos.y;
	pos.j = g->player.pos.x;
	it.i = -1;
	while (++it.i < 10)
	{
		it.j = -1;
		while (++it.j < 10)
		{
			if (pos.i + it.i < g->win.height && pos.j + it.j < g->win.width
				&& (it.i == 0 || it.i == 10 - 1 || it.j == 0 || it.j == 10 - 1))
...
{
	static double	ticks_last_frame;
	...
	g->player.pos.x += 50 * g->delta_time;
